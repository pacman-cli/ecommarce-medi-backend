...
/**
 * Payload for updating a purchase order in DRAFT status.
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Purchase order update request payload")
public class UpdatePurchaseOrderRequest {
    ...
    @Schema(description = "Notes or special instructions", example = "Updated shipment notes")
